...
// This was causing a TypeScript error because `window.aistudio` is likely already defined
// with a specific type in the global scope, and redeclaring it as `any` creates a conflict.
...
export const generateVideoLesson = async (
    ...
    // Note: Assuming API key is available in process.env.API_KEY for Netlify deployment.
